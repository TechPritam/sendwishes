...
//   return (
//     <div className="bg-[#FDFBF7] min-h-screen w-full relative selection:bg-rose-100 selection:text-rose-900 overflow-x-hidden font-sans">
//       <div
//         aria-hidden="true"
//         className="fixed inset-0 z-[0] bg-[url('/assets/rashmika.jpg')] bg-cover bg-center bg-no-repeat"
//       />
